                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="returnform" name="returnform" method="post" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="platform" class="col-form-label">Return From</label>
										...
										<select name="platform" id="platform" class="form-control" required>
											...
											<table id="returntable" class="card-repeat table" >
												...
												<tr>
													...
													<th>
                                                        <div class="form-group">
                                                        <label for="qty">Damage Status</label> 
                                                    </th>
													<th>
                                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="adtinf" class="col-form-label">Additional information</label>
