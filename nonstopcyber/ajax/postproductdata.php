...
$shelfnumber=$_REQUEST['shelf_number'];
		...
		$productinsert="INSERT INTO product(category, sub_category, brand, nsi_number, barcode, product_name,size,product_images,second_name, short_description,long_description,stocks_quantity,shelf_number) VALUES ('$category','$subcategory','$brand','$nsinumber','$barcode','$productname',
		'$productsize','$productimages','$secondname','$shortdescription','$longdescription','0','$shelfnumber')";	
