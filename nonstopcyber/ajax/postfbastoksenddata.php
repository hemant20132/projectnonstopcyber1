...
$subtotal=$_REQUEST['subtotal'];
	...
	$saleinsert="INSERT INTO sale(sale_image, orderno, platform, product_value, commissioncharges, shippingcharges, totalamount, addtinfo, username, tdate) 
	VALUES ('".$saleimages."','".$orderno."','".$platform."','".$productvalue."','".$commissioncharges."','".$shippingcharges."','".$totalamount."','".$adtinf."','".$_SESSION['username']
	."','".$saledate."')";
	if (mysqli_query($conn,$saleinsert))
	{
			...
			{
			$salesprinsert="INSERT INTO sale_products(saleid,saleorderno, barcode, nsinumber, productname, quantity, rate, subtotal) 
			...
			//stocks update
			$notetext="Added New Sales for product ".$productname[$i]." - Quantity-" .$quantity[$i]." - By: ".$_SESSION['name'];
			//add notification
