<?php 
 ...
 $query="select * from fbasale where id=".$saleid;
 echo $query;
...
if ($numrows>0)
{
	...
	$saleprquery="select * from fbasale_products where saleid='".$saledata['id']."'";
                                           ...
                                           <input id="saleid" name="saleid" type="hidden" value="<?php echo $saledata['id']; ?>" class="form-control" required>
											...
											<div class="form-group" id="imagegroup">
                                                <div class="imgadd">
													...
													<center><p><img class="output" src="fbasaleimages/<?php echo $images[$m];?>" width="100" height="100" /></p></center>
												</div>
											</div>
											<?php 
											}
											...
											for ($i=0;$i<sizeof($platform);$i++)
											{
												if ($platformname != $platform[$i]['platformname'])
                                                    ...
                                                    <option value="ct - Amazon">Cyber Trends</option>
                                                	<option value="cf - Amazon">Cyber Fashion</option>
                                                    <option value="cf - Amazon">Non Stop Guru</option>
                                                    <option value="cf - Amazon">Namaste Guruji</option>
                                                    </optgroup>
                                                    <optgroup label="Noon">
                                                    <option value="fzco - Noon">Middle East FZCO</option>
                                                    <option value="ctn - Noon">Cyber trends</option>
                                                    </optgroup>
                                                    <optgroup label="Carrefour">
                                                        <option value="cans - Careefour">Non Stop</option>
                                                        <option value="caau - Careefour">Aswani Uniforms</option>
                                                   </optgroup>
                                                    <optgroup label="Sharaf DG">
                                                        <option value="sharafdg - Sharaf DG">Sharaf DG</option>
                                                    </optgroup>
                                                    <optgroup label="Cartlow">
                                                        <option value="cartlow - Cartlow">Cartlow</option>
                                                    </optgroup>
										            <optgroup label="2071 mall">
                                                        <option value="2071mall - 2071 mall">2071 mall</option>
                                                    </optgroup>
													<optgroup label="Dubaistore">
                                                        <option value="Dubaistore - Dubai Store">Dubai Store</option>
                                                    </optgroup>
													<optgroup label="Ourshopee">
                                                        <option value="Ourshopee - Ourshopee">Ourshopee</option>
                                                    </optgroup>
													<optgroup label="Talabat">
                                                        <option value="Talabat - Talabat">Talabat</option>
                                                    </optgroup>
													<optgroup label="Measouq">
                                                        <option value="Measouq - Measouq">Measouq</option>
                                                    </optgroup>
													<optgroup label="Non Stop Cyber">
                                                        <option value="Nonstopcyber - Non Stop Cyber">Non Stop Cyber</option>
                                                    </optgroup>
													<optgroup label="Big Saver Hub">
                                                        <option value="Bigsaverhub - Big Saver Hub">Big Saver Hub</option>
                                                    </optgroup>
													<optgroup label="Elabelz">
                                                        <option value="Elabelz - Elabelz">Elabelz</option>
                                                    </optgroup>
													<optgroup label="tradeling">
                                                        <option value="tradeling - tradeling">tradeling</option>
                                                    </optgroup>
													<optgroup label="Meezzaa">
                                                        <option value="Meezzaa - Meezzaa">Meezzaa</option>
                                                    </optgroup>
													<optgroup label="Squareup">
                                                        <option value="Squareup - Squareup">Squareup</option>
                                                    </optgroup>
														<optgroup label="Cash Customer">
                                                        <option value="Cashcustomer - Cash Customer">Cash Customer</option>
                                                    </optgroup>
													-->
								             </div>
                                            <!--
		...
		$("#saveedit").click(function(e)
			{
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/posteditfbasaledata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
