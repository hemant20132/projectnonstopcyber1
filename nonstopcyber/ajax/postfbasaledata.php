...
$subtotal=$_REQUEST['subtotal'];
	...
	if (mysqli_query($conn,$saleinsert))
	{
			...
			for ($i=0;$i<sizeof($productname);$i++)
			{
				...
				//stocks update 
				$getstocks="select nsi_number,stocks_quantity from fba_product where platform='".$platform."' and nsi_number='".$nsinumber[$i]."'";
				...
				$updatestocks="update fba_product set stocks_quantity='".$replacestock."' where platform='".$platform."' and nsi_number='".$nsinumber[$i]."'";
