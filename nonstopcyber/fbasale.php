            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">FBA - Sale</h3>
		...
		$(document).on("change",".quantityclass",function(e)
				{
					...
					$.ajax({
					  method: "POST",
					  url: "ajax/getfbaproductstock.php",
					  cache: false,
					  dataType:'JSON',
		...
		$("#savesale").click(function(e)
			{
				...
				$(".barcodeclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbasale product barcode cannot be empty");
					return false;
					}	
				});
				$(".nsinumberclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbasale product nsinumber cannot be empty");
					return false;
					}	
				});
				$(".quantityclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbasale product quantity cannot be empty");
					return false;
					}	
				});
				$(".rateclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbasale product rate cannot be empty");
					return false;
					}	
				});
				if ($("#productvalue").val()=="")
