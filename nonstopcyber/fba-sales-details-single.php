        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">FBA Sales</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">FBA Sales Details</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
					...
					$querypr="select * from fbasale_products where saleid=".$saleid;
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
											<center>
											<?php $images = explode(",",$row['sale_image']); ?> 
											<img class="zoom" src="fbasaleimages/<?php echo $images[0];?>" width="240px" height="240px" style="max-height:150%; max-width:150%;margin-left:-10px;" alt="">
											</center>
											<br>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card" >
                                        <ul class="nav nav-tabs" id="myTab5" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="product-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="product-tab-2" aria-selected="false">FBA Sale Product Details</a>
                                            </li>
											<li class="nav-item">
                                                <a class="nav-link" id="product-tab-2" data-toggle="tab" href="#tab-3" role="tab" aria-controls="product-tab-3" aria-selected="false">FBA Sale Images</a>
                                            </li>
									    </ul>
				                            ...
				                            <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="product-tab-3">
												<div class="review-block">
													...
													<div class="rating-star mb-4 zoom">
														<img src="fbasaleimages/<?php echo $images[$i]; ?>" width="150" height="150">
													</div>
													<?php
													}
													?>
