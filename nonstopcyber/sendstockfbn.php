            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Send Stock FBN</h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Send Stock FBN</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Send Stock FBN</h3>
		...
		$("#savesale").click(function(e)
			{
				$(".saleimg").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("please upload fbn stock send image.");
					return false;
					}
				});	
				if ($("#receiptno").val()=="")
				...
				$(".barcodeclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnstocksend product bar code cannot be empty");
					return false;
					}	
				});
				$(".nsinumberclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnstocksend product nsi number cannot be empty");
					return false;
					}	
				});
				$(".quantityclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnstocksend product quantity cannot be empty");
					return false;
					}	
				});
				if ($("#adtinf").val()=="")
				...
				{
				alert('stock finished for the fbn stock send  product');
				return false;
				}
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/postsendstockfbndata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
