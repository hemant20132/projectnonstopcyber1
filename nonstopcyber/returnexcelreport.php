...
header("Content-Disposition: attachment; filename=returnreport.xls");  //File name extension was wrong
header("Expires: 0");
...
$returns="select * from return1 order by id";
...
$returnpro="select * from return_products order by id";
...
$returnreport="<center><p style='font-size:15pt;'>NonStopCyber -- return Report-</p></center><br/>";
