...
{
	$sno=$_REQUEST['s_no'];
	$queryproduct="select * from fbn_product where s_no=".$sno;
                                        ...
                                        <form id="productform" name="productform" enctype="multipart/form-data"  method="POST" action="">
											...
											<div class="form-group" id="imagegroup">
                                                <div class="imgadd">
													...
													<center><p><img class="output" src="fbnproductimages/<?php echo $images[$m];?>" width="100" height="100" /></p></center>
												</div>
											</div>
											<?php 
											}
    ...
    theme: 'bootstrap4',
		...
		//		CKEDITOR.replace('longdescription');
				$("#saveedit").click(function(e)
				{
					...
					$.ajax({
					  method: "POST",
					  url: "ajax/posteditfbnproductdata.php",
					  cache: false,
					  datatype:'json',
					  contentType: false,
					  processData: false,
