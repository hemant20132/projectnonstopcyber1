...
header("Content-Disposition: attachment; filename=productexcel.xls");  //File name extension was wrong
header("Expires: 0");
...
$product="select * from product order by s_no";
...
$productreport="<center><p style='font-size:15pt;'>NonStopCyber -- Stocks List -- ".$today."</p><br/></center>";
...
for ($i=0;$i<sizeof($productarr);$i++)
{
			...
			$barcodes2=$productarr[$i]['barcode'];
			...
			$productreport.="<td>".$productarr[$i]['nsi_number']."</td><td>".$barcodes."</td><td>".$productarr[$i]['product_name']."</td><td>".$productarr[$i]['product_images']."</td>";
