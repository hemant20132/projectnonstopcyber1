                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
                                            <center><img src="saleimages/<?php echo $row['sale_image']; ?>" style="max-height:100%; max-width:100%;" alt=""></center>
                                            <br>
                                            <!---
                                        ...
                                        <div class="product-size border-bottom">
                                            ...
                                            <table class="table">
											<thead>
											<tr><th><h4>Order No</h4></th><th><h4>Platform</h4><th><h4>Product Value</h4></th><th><h4>Commissioncharges</h4></th><th><h4>Total Amount</h4></th></tr>
                                            </thead>
											<tbody>
											<tr><td><?php echo $row['orderno']; ?></td><td><?php echo $row['platform']; ?></td><td><?php echo $row['product_value']; ?></td><td><?php echo $row['commissioncharges']; ?></td><td><?php echo $row['totalamount']; ?></td></tr>
											</tbody>
											</table>
											</div>
									    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card">
                                        ...
                                        <div class="tab-content" id="myTabContent5">
											...
											{
											?>
											<tr><td><?php echo $rowpr[$i]['saleorderno']; ?></td><td><?php echo $rowpr[$i]['nsinumber']; ?></td><td><?php echo $rowpr[$i]['productname']; ?></td><td><?php echo $rowpr[$i]['quantity']; ?></td></tr>
											<?php
											}
											?>
											</tbody>
