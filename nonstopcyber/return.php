										...
										<select name="platform" id="platform" class="form-control" required>
											...
											<table id="returntable" class="card-repeat table" >
                                                ...
                                                <tr id='0'>
													...
													<td>
                                                        <div class="form-group">
                                                        <select  name="damagestatus[]" class="form-control damagestatusclass" required>  
	...
	<script>
	   ...
	   $("#orderno").change(function(e)
		...
		$("#savereturn").click(function(e)
			{
				$(".returnimg").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("please upload return image.");
					return false;
					}	
				});
				if ($("#orderno").val()=="")
				...
				$(".barcodeclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("return products barcode cannot be empty");
					return false;
					}	
				});
				...
				$(".damagestatusclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("return damage status not selected");
					return false;	
					}	
				});
				...
				$(".subtotalclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("return subtotal cannot be empty");
						return false;	
		...
		$(document).on("change", ".quantityclass", function(e)
			{
				id=$(this).closest("tr").attr("id");
				qty=$(this).closest("tr").find(".quantityclass").val();
				rate=$(this).closest("tr").find(".rateclass").val();
				$("table tbody tr#"+id).find(".subtotalclass").val(qty*rate);
				$("#productvalue").val(qty*rate);
				$("#totalamount").val(qty*rate-$("#commissioncharges").val());
			});	
