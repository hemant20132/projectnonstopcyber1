<?php 
 ...
 $pquery="select * from platform  where platformname='FBA' order by id";
...
if ($numrows>0)
{
	...
	$saleprquery="select * from fbastocksend_products where saleid='".$saledata['id']."'";
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">FBA - Stocksend - Edit</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Edit Stocksend FBA</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">FBA - Stocksend Edit</h3>
									    ...
									    <form id="saleform" name="saleform" method="post" action="" enctype="multipart/form-data">
											...
											<div class="form-group" id="imagegroup">
                                                <div class="imgadd">
													...
													<center><p><img class="output" src="fbastocksendimages/<?php echo $images[$m];?>" width="100" height="100" /></p></center>
												</div>
											</div>
											<?php 
											}
        ...
        $(document).ready(function () 
		{
			...
			$(".add-row").click(function () {
				...
				{ 
					...
					$.ajax({
					  method: "POST",
					  url: "ajax/deletefbastocksendproduct.php",
					  cache: false,
					  datatype:'json',
		...
		$("#saveedit").click(function(e)
			{
				$(".saleimg").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbastocksend image  cannot be empty");
					return false;
					}	
				});
				if ($("#receiptno").val()=="")
				...
				$(".barcodeclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbastocksend product barcode cannot be empty");
					return false;
					}	
				});
				$(".nsinumberclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbastocksend product nsinumber cannot be empty");
					return false;
					}	
				});
				$(".quantityclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbastocksend product quantity cannot be empty");
					return false;
					}	
				});
				if ($("#adtinf").val()=="")
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/posteditfbastocksenddata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
		...
		$(document).on( "change", ".nsinumberclass", function(e)
			{
				...
				$.ajax({
				  ...
				  datatype : "JSON",
				  cache: false,
				  url: "ajax/getfbansinumberinfo.php",
