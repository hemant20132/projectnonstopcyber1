                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Damaged Product List</h2>
                            <p class="pageheader-text">Damaged Product List </p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Damaged Products</a></li>
								   ...
								   <table id="salestable" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <?php
                                            ...
                                            server with default setting (user 'root' with no password) */
												$query="select * from return_products as a, return1 as b where b.id=a.returnid and isdamaged='damaged'";
												echo $query;
												$i = 0;
												...
												if (mysqli_num_rows($result) > 0) 
												{
													...
													?>
<tr><td><?php echo $i; ?></td><td><div class="m-r-10"><img src="returnimages/<?php echo $row['sale_image'];?>" alt="saleimage" class="rounded" height="60" width="45"></div></td><td><?php echo $row['orderno'];?></td><td><?php echo date('d-m-Y',strtotime($row['tdate']));?></td><td><?php echo $platformname;?></td><td><?php echo $row['product_value'];?></td><td><?php echo $row['commissioncharges'];?></td><td><?php echo $row['shippingcharges'];?></td><td><?php echo $row['totalamount'];?></td><td><?php echo $row['addtinfo']; ?><td><a href="sales-details-single.php?saleid=<?php echo $row['id'];?>" class='btn btn-rounded btn-primary btn-sm float-right'>View Details</a></td><?php if ($_SESSION['role']=='Superuser' or $_SESSION['role']=='Admin' or ($_SESSION['role']=='User' AND $_SESSION['username']==$row['username'])){ ?><td><a href="edit-sale.php?saleid=<?php echo $row['id'];?>" class='btn btn-rounded btn-success btn-sm float-right'>Edit Details</a></td><?php } ?><?php if ($_SESSION['role']=='Superuser' OR $_SESSION['role']=='Admin' OR ($_SESSION['role'] == 'User' AND $_SESSION['username'] == $row['username'])){ ?><td><a href="" data-id="<?php echo $row['id']; ?>" class="btn btn-rounded btn-danger btn-sm float-right deletesale">Delete Details</a></td><?php } ?></tr>	
													<?php
