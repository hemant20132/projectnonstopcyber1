...
<head>
	...
	<link rel="stylesheet" type="text/css" href="phpfreechat-master/client/themes/default/pfc.css" />
    <script src="phpfreechat-master/client/pfc.js" type="text/javascript"></script>
	<!--
...
<body>
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <!-- ============================================================== -->
                    	<?php
							     		 $today=date("Y-m-d");
										 $dsales="Select * from sale where DATE(tdate)='".$today."'";
										 ...
										 if ($numrows>0)
										 {
											 ...
											 {
												 $totalsalestoday=$totalsalestoday+$row['totalamount'];
											 }	
										 }
										 
										 $today=date("Y-m-d");
										 $dreturns="Select * from return1 where DATE(tdate)='".$today."'";
										 $resultreturns=mysqli_query($conn,$dreturns); 
										 $numrows1=mysqli_num_rows($resultreturns);
										 $count1=0;
										 $totalreturnstoday=0;
										 if ($numrows1>0)
										 {
											 while($rowreturn=mysqli_fetch_array($resultreturns,MYSQLI_ASSOC))
											 {
												 $totalreturnstoday=$totalreturnstoday+$rowreturn['totalamount'];
											 }	
										 }
										 
										 
										 
										 $tsales="Select * from sale";
										 ...
										 if ($tnumrows>0)
										 {
											 ...
											 {
												 $totalsales=$totalsales+$trow['totalamount'];
											 }	
										 }
										 
										 $treturns="Select * from return1";
										 $tresultreturn=mysqli_query($conn,$treturns); 
										 $tnumrowsreturn=mysqli_num_rows($tresultreturn);
										 $tcount1=0;
										 $totalreturns=0;
										 if ($tnumrowsreturn>0)
										 {
											 while($trowreturn=mysqli_fetch_array($tresultreturn,MYSQLI_ASSOC))
											 {
												 $totalreturns=$totalreturns+$trowreturn['totalamount'];
											 }	
										 }
                    ...
                    <div class="ecommerce-widget">
                     <div class="row">
                              <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
									...
									<center>
						                ...
						                <h5 class="text-muted"><a class="btn btn-primary btn-sm btn-rounded" width="200px" href='sendstockfba.php'>Stock Transfer - FBA</a></h5>
						                <h5 class="text-muted"><a class="btn btn-primary btn-sm btn-rounded" width="200px" href='sendstockfbn.php'>Stock Transfer - FBN</a></h5>
						            </center>
									</div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">AED.<?php echo ($totalsalestoday+$totalreturnstoday); ?></h1>
                                        </div>
						    ...
						    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">AED.<?php echo ($totalsales+$totalreturns); ?></h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
										      <span></span>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">AED.<?php echo $totalreturns; ?></h1>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <!-- recent orders  -->
                            <?php
										 $salesquery="select * from sale order by id  desc LIMIT 4";
                                    ...
                                    <div class="card-body">
										...
										?>
													<tr>
                                                        ...
                                                        <td>
                                                            <div class="m-r-10"><img src="saleimages/<?php echo $row['sale_image'];?>" alt="user" class="rounded" height="60" width="45"></div>
                                                        </td>
	...
	<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                        ...
                                        <ul class="traffic-sales list-group list-group-flush">
											...
											while ($rowspr=mysqli_fetch_array($productres,MYSQLI_ASSOC))
											{
												for ($s=0;$s<sizeof($unfcount);$s++)
												{
													...
													and a.nsinumber='".$rowspr['nsi_number']."' order by b.id desc";
													$fifoprice=0;
											...
											?>
											<li class="traffic-sales-content list-group-item "><span class="traffic-sales-name"><?php echo $rowspr['product_name']; ?></span><span class="traffic-sales-amount">AED<?php echo $unfcount[$s]['total_count']*$fifoprice;?><span class="icon-circle-small icon-box-xs text-success ml-4 bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span></li>
                                            <?php
													}
												}
											}
						 ...
						 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                ...
                                <!-- social source  -->
                                <?php
								$salesbybr="SELECT count(a.nsinumber), sum(a.quantity*a.rate) as totalsales,
								b.brand as brand, c.brand as brandname from sale_products as a, 
								product as b, brand as c 
								where b.brand=c.code and a.nsinumber = b.nsi_number group by b.brand"; 
								$salesresultbybr=mysqli_query($conn,$salesbybr);
								?>				
								<!-- ============================================================== -->
                                <div class="card">
                                    <h5 class="card-header"> Sales By Brand</h5>
                                    <div class="card-body p-0">
                                        <ul class="social-sales list-group list-group-flush">
                                    	<?php
											while ($row1=mysqli_fetch_array($salesresultbybr,MYSQLI_ASSOC))
											{
										?>
										<li class="list-group-item social-sales-content"><?php echo $row1['brandname']; ?><span class="social-sales-count text-dark">AED.<?php echo $row1['totalsales']; ?></span>
                                        </li>
											<?php
											}
											?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
										...
										<li class="country-sales-content list-group-item"><span class="mr-2"><?php echo $rowplat['platformname']."-".$rowplat['platformsub']; ?></span>
                                                <span class=""></span><span class="float-right text-dark">AED.<?php echo $rowplat['platformtotal']; ?></span>
                                        </li>
                                        <?php
											}
										?>
    ...
    <div id="mychat"><a href="http://www.phpfreechat.net">chat</a></div>
	<!-- ============================================================== -->
    <!-- end main wrapper  -->
    <!-- ============================================================== -->
    <!-- Optional JavaScript -->
	...
	$('#mychat').phpfreechat({serverUrl: '/phpfreechat-master/server' });
	</script>
    <!-- bootstap bundle js -->
