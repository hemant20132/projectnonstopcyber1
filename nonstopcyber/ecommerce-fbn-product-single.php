        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">FBA Product</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">FBA product Single</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
					...
					$productid=$_GET['s_no'];
					$query="select * from fbn_product where s_no=".$productid;
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
                                            <center><img src="fbnproductimages/<?php echo $images[0]; ?>" style="max-height:100%; max-width:100%;" alt=""></center>
                                            <br>
                                        ...
                                        <div class="product-size border-bottom">
											...
											<div class="product-qty">
                                                <h4>Quantity</h4>
                                                <div class="quantity">
                                                    <input type="number"  value="<?php echo $row['stocks_quantity'];?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="simple-card">
                                        ...
                                        <div class="tab-content" id="myTabContent5">
                                            ...
                                            <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="product-tab-2">
												...
												{
													if ($categorylist[$i]["code"]==$row["category"])
													{
													echo $categorylist[$i]["categoryname"];
													}
												}
												?>
												</td></tr>
												...
												{
													if ($subcategorylist[$i]["subcategorycode"]==$row["sub_category"])
													{
													echo $subcategorylist[$i]["subcategoryname"];
													}
												}
												?>
												</td></tr>
												...
												{
													if ($brandlist[$i]["code"]==$row["brand"])
													{
													echo $brandlist[$i]["brand"];
													}
												}
												?>
												</td></tr>
				                            ...
				                            <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="product-tab-3">
												<div class="review-block">
													...
													<div class="rating-star mb-4 zoom">
														<img src="fbnproductimages/<?php echo $images[$i]; ?>" width="150" height="150">
													</div>
													<?php
													}
													?>
