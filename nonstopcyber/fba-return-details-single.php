        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">FBA Sales Return </h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">FBA Retrun Product</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">FBA Return Details</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
					...
					$querypr="select * from fbareturn_products where returnid='".$returnid."'";
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
										...
										?>
                                            <center><img class="zoom" src="fbareturnimages/<?php echo $images[0]; ?>" width="300px" height="300px" style="max-height:150%; max-width:150%;" alt=""></center>
                                            <br>
                                            <!---
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card">
                                        <ul class="nav nav-tabs" id="myTab5" role="tablist">
											...
											<li class="nav-item">
                                                <a class="nav-link" id="product-tab-3" data-toggle="tab" href="#tab-3" role="tab" aria-controls="product-tab-3" aria-selected="false">FBA Return Images</a>
                                            </li>
								        </ul>
