        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">E-commerce Purchase </h2>
                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">E-coommerce</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">E-Commerce Purchase Details</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
					...
					$querypr="select * from purchase_products where purchaseid=".$purchaseid;
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        ...
                                        <div class="product-size border-bottom">
											...
											<table class="table">
											<thead>
											<tr><th>Invoice No.</th><th>Date</th><th><h4>Product Value</h4></th><th>UserName</th></tr>
                                            </thead>
											<tbody>
											<tr><td><?php echo $row['invoiceno'];?></td><td><?php echo date("d-m-Y",strtotime($row['tdate']));?></td><td><?php echo $row['product_value']; ?></td><td><?php echo $username; ?></td></tr>
											</tbody>
											</table>
											</div>
									    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card">
                                        <ul class="nav nav-tabs" id="myTab5" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="product-tab-2" data-toggle="tab" href="#tab-2" role="tab" aria-controls="product-tab-2" aria-selected="false">Purchase Product Details</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent5">
			                                ...
			                                <table class="table">
											<thead>
											<tr><th><h4>NSI No</h4></th><th><h4>Product Name</h4></th><th><h4>Quantity</h4></th><th><h4>Rate</h4></th></tr>
                                            </thead>
											<tbody>
											<?php 
											...
											?>
											<tr><td><?php echo $rowpr[$i]['nsinumber']; ?></td><td><?php echo $rowpr[$i]['productname']; ?></td><td><?php echo $rowpr[$i]['quantity']; ?></td><td><?php echo $rowpr[$i]['rate']; ?></td></tr>
											<?php
											}
											?>
											</tbody>
