        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <h5 class="card-header">Basic Form (Fields marked with <span style="color:red;">*</span> are compulsory.)</h5>
                                    <div class="card-body">
        ...
        $(document).ready(function () 
		{
			...
			$(".add-row").click(function () {
				...
				{ 
					...
					$.ajax({
					  method: "POST",
					  url: "ajax/deletefbasaleproduct.php",
					  cache: false,
					  datatype:'json',
