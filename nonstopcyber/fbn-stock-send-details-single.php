        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">FBN - Stock Send View Details</h2>
					...
					$querypr="select * from fbnstocksend_products where saleid=".$saleid;
					...
					?>
											<style>
													...
													.zoom:hover {
													  transform: scale(3.0); /* (300% zoom - Note: if the zoom is too large, it will go outside of the viewport) */
													}
											</style>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
											<center>
											<img class="zoom" src="fbnstocksendimages/<?php echo $row['sale_image'];?>" width="240px" height="240px" style="max-height:150%; max-width:150%;margin-left:-10px;" alt="">
											</center>
											<br>
										    <h3 class="mb-0 text-primary totalamount" ></h3>
										</div>
                                        <div class="product-size border-bottom" >
                                         	<div class="table-responsive">
											<table class="table" id="saletable">
											<thead>
											<tr><th><h4>Receipt No</h4></th><th><h4>Platform</h4><th><h4>User Name</h4></th></tr>
                                            </thead>
											<tbody>
											<?php
											...
											?>
											<tr><td><?php echo $row['receiptno']; ?></td><td><?php echo $platformname; ?></td><td><?php echo $username; ?></td></tr>
											</tbody>
											</table>
											</div>
										</div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card" >
                                        ...
                                        <div class="tab-content" id="myTabContent5" >
											...
											<table class="table">
											<thead>
											<tr><th><h4>Receipt No</h4></th><th><h4>NSI No</h4><th><h4>Product Name</h4></th><th><h4>Quantity</h4></th></tr>
                                            </thead>
											<tbody>
											<?php 
											...
											{
											?>
											<tr><td><?php echo $rowpr[$i]['receiptno']; ?></td><td><?php echo $rowpr[$i]['nsinumber']; ?></td><td><?php echo $rowpr[$i]['productname']; ?></td><td><?php echo $rowpr[$i]['quantity']; ?></td></tr>
											<?php
											}
											?>
											</tbody>
