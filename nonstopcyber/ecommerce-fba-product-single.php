        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
					...
					$productid=$_GET['s_no'];
					$query="select * from fba_product where s_no=".$productid;
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
                                            <center><img src="fbaproductimages/<?php echo $images[0]; ?>" style="max-height:100%; max-width:100%;" alt=""></center>
                                            <br>
				                            ...
				                            <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="product-tab-3">
												<div class="review-block">
													...
													<div class="rating-star mb-4 zoom">
														<img src="fbaproductimages/<?php echo $images[$i]; ?>" width="150" height="150">
													</div>
													<?php
													}
													?>
