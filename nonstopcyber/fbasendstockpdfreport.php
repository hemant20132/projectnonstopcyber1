<?php
$filename="fbastockpdfreport.pdf";
header("Content-type: application/octet-stream");                       
header('Content-Disposition: inline; filename=fbastockpdfreport.pdf');
...
$sales="select * from fbastocksend where platform='".$platform."' and tdate >='".$fromdate."' and tdate<='".$todate."' order by id";
...
$salereport="<center><p style='font-size:15pt;'>NonStopCyber -- FBA Stock Send Report-</p></center><br/>";
