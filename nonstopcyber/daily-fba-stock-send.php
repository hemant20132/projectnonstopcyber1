        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Todays FBA Stock Send Report</h2>
                            <p class="pageheader-text"></p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">FBA Send</a></li>
                ...
                <div class="row">
                    ...
                    <!-- ============================================================== -->
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <a  class="btn btn-primary" href="downloaddailyfbastocksend.php">DownloadExcel</a>
						<div class="card">
						<center>
						<h5 class="card-header">Daily FBA Send Stock Report -<?php $today=date('d-m-Y'); echo $today; ?></h5><div class="float-right">
						</center>
						</div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
										 ...
										 b.quantity as quantity, b.fiforate from fbastocksend as a, fbastocksend_products as b, 
										 product as c  
										...
										?>	
                                            	...
                                            	<td><?php echo $row['quantity']*$row['fiforate']; $total = $total + ($row['quantity']*$row['fiforate']);?></td>
                                              </tr>
                                         <?php 
										 }
										 }
