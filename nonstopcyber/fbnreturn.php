                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">FBN - Return</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
										...
										<select name="platform" id="platform" class="form-control" required>
											...
											<table id="returntable" class="card-repeat table" >
                                                ...
                                                <tr id='0'>
													...
													<td>
                                                        <div class="form-group">
                                                        <input  type="number" name="subtotal[]" class="form-control rateclass" required>  
                                                        </div>
                                                    </td>
											    </tr>
												</tbody>
											...
											<div class="form-group">
                                                ...
                                                <input id="productvalue" value="" name="product_value" type="number" class="form-control">
                                            </div>
                                            <div class="form-group">
		...
		$("#savereturn").click(function(e)
			{
				$(".returnimg").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("please upload fbnreturn  image.");
					return false;
					}	
				});
				if ($("#orderno").val()=="")
				{
					alert("Enter fbnreturn Order No.");
					return false;	
				}
				if ($("#platform").val()=="")
				{
					alert("Enter fbnreturn Platform No.");
					return false;	
				}
				$(".barcodeclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnreturn products barcode cannot be empty");
					return false;
					}	
				});
				$(".nsinumberclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnreturn products nsinumber cannot be empty");
					return false;
					}	
				});
				$(".quantityclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnreturn products quantity cannot be empty");
					return false;	
					}	
				});
				$(".damagestatusclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnreturn products damage status not selected");
					return false;	
					}	
				});
				$(".rateclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbnreturn products rate cannot be empty");
						return false;	
					}	
				});
				if ($("#productvalue").val()=="")
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/postfbnreturndata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
