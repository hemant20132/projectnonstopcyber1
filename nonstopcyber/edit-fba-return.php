<?php
 ...
 $query="select * from fbareturn1 where id=".$returnid;
...
if ($numrows>0)
{
	...
	$returnprquery="select * from fbareturn_products where returnid='".$returndata['id']."'";
	echo $returnprquery;
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">FBA Return - Edit</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                        ...
                                        <form id="returnform" name="returnform" method="post" action="" enctype="multipart/form-data">
											...
											<div class="form-group" id="imagegroup">
                                                <div class="imgadd">
													...
													<center><p><img class="output" src="fbareturnimages/<?php echo $images[$m];?>" width="100" height="100" /></p></center>
												</div>
											</div>
											<?php 
											}
                                            ...
                                            <div style="width: 300px" id="reader"></div>
												...
												<tr id="<?php echo $x; ?>">
                                                    <td>
														<input  type="hidden"  value="<?php echo $returnproducts[$x]['id'];?>" name="id[]" class="idclass form-control" required>
                                            			<input  type="text"  value="<?php echo $returnproducts[$x]['barcode'];?>" name="barcode[]" class="barcodeclass form-control" required>
                                                    </td>
                                                    <td>
														<input type="text" value="<?php echo $returnproducts[$x]['nsinumber'];?>" name="nsinumber[]" class="nsinumberclass form-control" required>
													</td>
                                                    <td>
                                                        <input  type="text" value="<?php echo $returnproducts[$x]['productname'];?>" name="productname[]" class="productnameclass form-control">
                                                    </td>
                                                    <td>
                                                        <input  type="number" value="<?php echo $returnproducts[$x]['quantity'];?>" name="quantity[]" class="quantityclass form-control">  
                                                    </td>
											    	<td>
                                                        <select  class="form-control damagestatusclass" name="damagestatus[]">  
													...
													<td>
                                                        <input  type="number" name="rate[]"  value="<?php echo $returnproducts[$x]['rate'];?>" class="rateclass form-control">  
                                                    </td>
													<td>
                                                        <input  type="number" name="subtotal[]"  value="<?php echo $returnproducts[$x]['subtotal'];?>" class="subtotalclass form-control">  
                                                    </td>
											    </tr>
												<?php 
													}
                                            ...
                                            <button  id="editsave" name="edittsave" type="submit" class="btn btn-primary btn-block">Edit Save</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
		...
		$("#editsave").click(function(e)
			{
				$(".output").each(function() 
				{
					if ($(this).attr("src")=="")
					{
					alert("please select fbareturn image.");
					}	
				});
				if ($("#orderno").val()=="")
				{
				...
				$(".rateclass").each(function() 
				{
					if ($(this).val()=="")
					{
					alert("fbareturn products rate cannot be empty");
					}	
				});
				...
				{
					alert("please enter Commission Charges.");
					return false;
				}
				if ($("#totalamount").val()=="")
				{
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/posteditfbareturndata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
