...
$returns="select * from fbareturn1 order by id";
...
$returnpro="select * from fbareturn_products order by id";
...
$returnreport="<center><p style='font-size:15pt;'>NonStopCyber -- FBA Return Report-</p></center><br/>";
