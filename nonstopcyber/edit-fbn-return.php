<?php
 ...
 $query="select * from fbnreturn1 where id=".$returnid;
...
if ($numrows>0)
{
	...
	$returnprquery="select * from fbnreturn_products where returnid='".$returndata['id']."'";
	echo $returnprquery;
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">FBN - Return</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">FBN Return - Edit</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">FBN - Return</h3>
                                        ...
                                        <form id="returnform" name="returnform" method="post" action="" enctype="multipart/form-data">
											...
											<div class="form-group" id="imagegroup">
                                                <div class="imgadd">
													...
													<center><p><img class="output" src="fbnreturnimages/<?php echo $images[$m];?>" width="100" height="100" /></p></center>
												</div>
											</div>
											<?php 
											}
		...
		$("#editsave").click(function(e)
			{
				...
				$.ajax({
				  method: "POST",
				  url: "ajax/posteditfbnreturndata.php",
				  cache: false,
				  datatype:'json',
				  contentType: false,
				  processData: false,
