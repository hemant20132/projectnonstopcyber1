        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">FBA - Stock Send View Details</h2>
					...
					$saleid=$_GET['saleid'];
					$query="select * from  fbastocksend where id=".$saleid;
					...
					$querypr="select * from fbastocksend_products where saleid=".$saleid;
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="product-details">
                                        <div class="border-bottom pb-3 mb-3">
											<center>
											<img class="zoom" src="fbastocksendimages/<?php echo $row['sale_image'];?>" width="240px" height="240px" style="max-height:150%; max-width:150%;margin-left:-10px;" alt="">
											</center>
											<br>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-60">
                                    <div class="simple-card" >
                                        ...
                                        <div class="tab-content" id="myTabContent5" >
											...
											<table class="table">
											<thead>
											<tr><th><h4>Order No</h4></th><th><h4>NSI No</h4><th><h4>Product Name</h4></th><th><h4>Quantity</h4></th></tr>
                                            </thead>
											<tbody>
											<?php 
