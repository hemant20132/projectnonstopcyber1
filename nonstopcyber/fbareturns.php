									...
									<form id="filterform" name="filterform" method="post">
									  <div class="row">
										...
										<?php
											...
											{	
											?>
										<input type="date" class="form-control" id="fromdate" value="" name="fromdate" placeholder="From Date" >
											<?php
											}
											?>
										</div>
										<div class="col">
										  ...
										  <input type="date" class="form-control" id="todate" name="todate" value="<?php echo $todate; ?>" placeholder="To Date" >
											...
											{	
											?>
											<input type="date" class="form-control" id="todate" name="todate" value="" placeholder="To Date" >
											<?php
											}
											?>
										</div>
